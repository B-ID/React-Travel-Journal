...
// mapping the options to list an array of JSX options
...
export default class Forms2 extends Component {
  ...
  handleChange = (e) => {
    /*
   We can get the name of the value like: e.target.name, e.target.value 
We can also destructure the name and value from e.target
